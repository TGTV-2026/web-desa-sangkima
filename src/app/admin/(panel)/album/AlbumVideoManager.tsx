        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
          {videos.map((v) => (
            ...
            >
              ...
              {/* Aksi muncul saat kartu di-hover (lihat .thumb-actions di globals.css) */}
              <div className="thumb-actions absolute inset-x-0 bottom-0 flex justify-end bg-gradient-to-t from-black/70 to-transparent p-1.5">
                <button
                  type="button"
                  onClick={() => hapus(v.id)}
                  disabled={pending}
